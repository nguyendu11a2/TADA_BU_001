...
import {confirmPasswordReset, createUserWithEmailAndPassword,getAuth,updateProfile } from 'firebase/auth';
...
const Register = ({navigation})=>{
  ...
  const validatForm =()=>{
    var form_inputs = [email,password,confirmPassword];
      ...
      <View style={styles.container}>
        ...
        <View style={styles.centerizedView}>
          <View style={styles.authBox}>
            ...
            <TouchableOpacity style={styles.loginButton} onPress={validatForm}>
